...
describe("publicSale", () => {
    ...
    describe("claim test", () => {
        ...
        it("claimTime1, claim call account2", async () => {
            await publicSaleContract.connect(account2).claim()
        })

        it("claimTime1, claim call account3", async () => {
            await publicSaleContract.connect(account3).claim()
        })

        it("claimTime1, claim call account4", async () => {
            await publicSaleContract.connect(account4).claim()
        })

        it("claimTime1, claim call account6", async () => {
        ...
        it("claimTime2, claim call account2", async () => {
            await publicSaleContract.connect(account2).claim()
        })

        it("claimTime2, claim call account3", async () => {
            await publicSaleContract.connect(account3).claim()
        })

        it("claimTime2, claim call account4", async () => {
            await publicSaleContract.connect(account4).claim()
        })

        it("claimTime2, claim call account6", async () => {
            await publicSaleContract.connect(account6).claim()
        })
        ...
        it("claimTime3, claim call account2", async () => {
            await publicSaleContract.connect(account2).claim()
        })

        it("claimTime3, claim call account3", async () => {
            await publicSaleContract.connect(account3).claim()
        })

        it("claimTime3, claim call account4", async () => {
            await publicSaleContract.connect(account4).claim()
        })

        it("claimTime3, claim call account6", async () => {
            await publicSaleContract.connect(account6).claim()
        })
        ...
        it("claimTime4, claim call account2", async () => {
            await publicSaleContract.connect(account2).claim()
        })

        it("claimTime4, claim call account3", async () => {
            await publicSaleContract.connect(account3).claim()
        })

        it("claimTime4, claim call account4", async () => {
            await publicSaleContract.connect(account4).claim()
        })

        it("claimTime4, claim call account6", async () => {
            await publicSaleContract.connect(account6).claim()
        })
        ...
        it("claimTime5, claim call account2", async () => {
            await publicSaleContract.connect(account2).claim()
        })

        it("claimTime5, claim call account3", async () => {
            await publicSaleContract.connect(account3).claim()
        })

        it("claimTime5, claim call account4", async () => {
            await publicSaleContract.connect(account4).claim()
        })

        it("claimTime5, claim call account6", async () => {
            await publicSaleContract.connect(account6).claim()
        })
