...
describe("Sale", () => {
    ...
    describe("Sale", () => {
        ...
        describe("openSale Sale", () => {
            ...
            it("openSale function", async () => {
                ...
                expect(Number(tx.totalClaimReward)).to.be.equal(0)
                ...
                expect(beforeTON).to.be.equal(940)
                ...
                expect(afterTON).to.be.equal(1340)

                let tx5 = await saleContract.usersClaim(account1.address)
                expect(Number(tx5.totalClaimReward)).to.be.equal(100000)
                ...
                expect(Number(tx8.totalClaimReward)).to.be.equal(400000)
                ...
                expect(Number(tx10.saleAmount)).to.be.equal(0)
            })
    ...
    describe("claim test", () => {
        ...
        it("claim period = 2, claim call the account1, account2", async () => {
            ...
            expect(Number(claimAmount1.claimAmount)).to.be.equal(expectClaim)
        ...
        it("claim period = 3, claim call the account1, account3", async () => {
            ...
            let claimAmount1 = await saleContract.usersClaim(account1.address)
            expect(Number(claimAmount1.claimAmount)).to.be.equal((expectClaim*2))
        ...
        it("claim period = 4, claim call the account1, account4", async () => {
            ...
            let claimAmount1 = await saleContract.usersClaim(account1.address)
            expect(Number(claimAmount1.claimAmount)).to.be.equal((expectClaim*3))
        ...
        it("claim period = 6, claim call the account1, account2", async () => {
            ...
            let claimAmount1 = await saleContract.usersClaim(account1.address)
            expect(Number(claimAmount1.claimAmount)).to.be.equal(66664)
        ...
        it("claim period end, claim call the account1, account3, account4, account6", async () => {
            ...
            let claimAmount2 = await saleContract.usersClaim(account4.address)
            expect(Number(claimAmount2.claimAmount)).to.be.equal(266664)
            let claimRemainAmount2 = Number(claimAmount2.totalClaimReward) - Number(claimAmount2.claimAmount)
        ...
        it("data check", async () => {
            ...
            expect(Number(tx13.totalClaimReward)).to.be.equal(400000)
        })
