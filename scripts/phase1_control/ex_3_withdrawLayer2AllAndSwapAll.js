...
async function deployMain(defaultSender) {
  ...
  let tx1 = await stakeTONControl.connect(deployer).withdrawLayer2AllAndSwapAll([0,0,0,0,0]);
  console.log("withdrawLayer2AllAndSwapAll StakeTONControl ", tx1.hash);
  printGasUsedOfUnits('withdrawLayer2AllAndSwapAll StakeTONControl',tx1);
  return null;
}
