...
async function deployMain(defaultSender) {
  ...
  let tx1 = await stakeTONControl.connect(deployer).SwapAll([0,0,0,0,0]);
  console.log("SwapAll StakeTONControl ", tx1.hash);
  printGasUsedOfUnits('SwapAll StakeTONControl',tx1);
  return null;
}
