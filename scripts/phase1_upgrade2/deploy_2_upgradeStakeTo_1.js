...
async function deployMain(defaultSender) {
  ...
  let tx1 = await stakeEntry.upgradeStakeTo(process.env.PHASE1_TON_1_ADDRESS, StakeTONUpgrade2);
  console.log("upgradeStakeTo PHASE1_TON_1_ADDRESS", tx1.hash);
  printGasUsedOfUnits('upgradeStakeTo PHASE1_TON_1_ADDRESS',tx1);
