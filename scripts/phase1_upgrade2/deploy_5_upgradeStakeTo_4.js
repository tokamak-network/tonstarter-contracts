...
async function deployMain(defaultSender) {
  ...
  let tx2 = await stakeEntry.upgradeStakeTo(process.env.PHASE1_TON_4_ADDRESS, StakeTONUpgrade2);
  await tx2.wait();

  console.log("upgradeStakeTo PHASE1_TON_4_ADDRESS", tx2.hash);
  printGasUsedOfUnits('upgradeStakeTo PHASE1_TON_4_ADDRESS',tx2);
