...
async function deployMain(defaultSender) {
  ...
  console.log("setImplementation2 PHASE1_TON_3_ADDRESS StakeTONUpgrade3", tx1.hash);
  printGasUsedOfUnits('setImplementation2 PHASE1_TON_3_ADDRESS StakeTONUpgrade3',tx1);
