...
async function deployMain(defaultSender) {
  ...
  console.log("ton:", ton);
  let tonbalance = await tonContract.balanceOf(process.env.PHASE1_TON_1_ADDRESS);
  console.log("tonbalance:", tonbalance.toString());


  let tx1 = await tonContract.connect(user1).transfer(
  ...
  tonbalance = await tonContract.balanceOf(process.env.PHASE1_TON_1_ADDRESS);
  console.log("tonbalance:", tonbalance.toString());
