...
async function deployMain(defaultSender) {
  ...
  console.log(
    "setImplementation2 PHASE1_TON_5_ADDRESS StakeTONUpgrade2 ",
    tx1.hash
  );
  printGasUsedOfUnits(
    "setImplementation2 PHASE1_TON_5_ADDRESS StakeTONUpgrade2",
  ...
  console.log(
    "setImplementation2 PHASE1_TON_5_ADDRESS StakeTONUpgrade3",
    tx2.hash
  );
  printGasUsedOfUnits(
    "setImplementation2 PHASE1_TON_5_ADDRESS StakeTONUpgrade3",
  ...
  console.log(
    "setSelectorImplementations2 PHASE1_TON_5_ADDRESS withdraw",
    tx3.hash
  );
  printGasUsedOfUnits(
    "setSelectorImplementations2 PHASE1_TON_5_ADDRESS withdraw",
