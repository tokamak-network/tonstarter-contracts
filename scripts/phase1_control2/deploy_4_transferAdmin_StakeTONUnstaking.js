...
let newAdmin="0x865264b30eb29A2978b9503B8AfE2A2DDa33eD7E";
*/

// mainnet
//## TRANSFER ADMIN : Tonstarker : 0x15280a52E79FD4aB35F4B9Acbb376DCD72b44Fd1
...
let newAdmin="0x15280a52E79FD4aB35F4B9Acbb376DCD72b44Fd1";
...
async function deployMain(defaultSender) {
  ...
  let tx1 = await stakeTONUnstaking.connect(deployer).transferAdmin(
    newAdmin
    );
  console.log("transferAdmin StakeTONUnstaking ", tx1.hash);

  printGasUsedOfUnits('transferAdmin StakeTONUnstaking',tx1);
  return null;
}
