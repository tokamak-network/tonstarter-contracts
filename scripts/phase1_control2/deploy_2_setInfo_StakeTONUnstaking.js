...
async function deployMain(defaultSender) {
  ...
  let tx1 = await stakeTONUnstaking.connect(deployer).setInfo(
    ton,
    wton,
    tostoken,
    DepositManager,
  ...
  console.log("setInfo StakeTONUnstaking ", tx1.hash);

  printGasUsedOfUnits('setInfo StakeTONUnstaking',tx1);
  return null;
}
